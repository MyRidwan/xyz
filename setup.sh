...
echo -e "Telegram : t.me/r1f4n_1122"
rm -f setup-lite.sh
exit 0
fi
clear
...
./xray.sh
sleep 1
wget https://raw.githubusercontent.com/myridwan/xyz/ipuk/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
echo -e "${GREEN}Done!${NC}"
sleep 2
clear
#Install SET-BR
...
./set-br.sh
wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/myridwan/xyz/ipuk/index.html"
echo -e "${GREEN}Done!${NC}"
sleep 2
clear
...
echo ""
echo -e "${CB}————————————————————————————————————————————————————————${NC}"
echo -e "${RB}          🚀 ${NC} ${WB}${bold}Premium Autoscript By KytProject ${NC} ${RB}🚀 ${NC}"
echo -e "${CB}————————————————————————————————————————————————————————${NC}"
...
echo -e "${CB}————————————————————————————————————————————————————————${NC}"
echo -e "           ${WB}»»» ${bold}Autoscript By KytProject «««${NC}             "
echo -e "${CB}————————————————————————————————————————————————————————${NC}"${NC}"
echo ""
